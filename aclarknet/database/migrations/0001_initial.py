# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-01-03 16:54
    ...
    operations = [
            ...
            fields=[
                ...
                ('estimate_counter',
                 models.IntegerField(blank=True,
                                     null=True,
                                     verbose_name=b'Estimate Counter')),
                ('invoice_counter',
                 models.IntegerField(blank=True,
                                     null=True,
                                     verbose_name=b'Invoice Counter')),
                ('currency_symbol',
                 models.CharField(blank=True,
                                  default=b'$',
                                  max_length=300,
                                  null=True,
                                  verbose_name=b'Currency Symbol')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(blank=True,
                                               ...
                                               max_digits=12,
                                               null=True,
                                               verbose_name=b'Estimate Amount')
                 ),
                ('document_id',
                 models.IntegerField(blank=True,
                                     null=True,
                                     verbose_name=b'Estimate ID')),
                ('discount', models.IntegerField(blank=True,
                                                 null=True)),
                ('tax', models.IntegerField(blank=True,
                                            null=True)),
                ('tax2', models.IntegerField(blank=True,
                                             null=True)),
                ('currency',
                 models.CharField(blank=True,
                                  default=b'United States Dollar - USD',
                                  max_length=300,
                                  null=True)),
                ('accepted_date', models.DateField(blank=True,
                                                   null=True)),
                ('declined_date', models.DateField(blank=True,
                                                   null=True)),
                ('client',
                 models.ForeignKey(blank=True,
                                   null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_id', models.IntegerField(blank=True,
                                                    null=True,
                                                    verbose_name=b'Invoice ID')
                 ),
                ('po_number', models.CharField(blank=True,
                                               max_length=300,
                                               null=True,
                                               verbose_name=b'PO Number')),
                ('subject', models.CharField(blank=True,
                                             max_length=300,
                                             null=True)),
                ('amount', models.DecimalField(blank=True,
                ...
                ('currency',
                 models.CharField(blank=True,
                                  ...
                                  max_length=300,
                                  null=True)),
                ('currency_symbol', models.CharField(blank=True,
                                                     default=b'$',
                                                     max_length=300,
                                                     null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate', models.DecimalField(blank=True,
                                             ...
                                             max_digits=12,
                                             null=True)),
                ('unit', models.DecimalField(blank=True,
                                             decimal_places=2,
                                             default=1.0,
                                             max_digits=12,
                                             null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True,
                                          ...
                                          null=True,
                                          unique=True,
                                          verbose_name=b'Project Name')),
                ('code', models.IntegerField(blank=True,
                                             null=True,
                                             verbose_name=b'Project Code')),
                ...
                ('notes', models.TextField(blank=True,
                                           null=True)),
                ('total_hours', models.FloatField(blank=True,
                                                  null=True)),
                ('billable_hours', models.FloatField(blank=True,
                                                     null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_code', models.IntegerField(blank=True,
                                                     null=True)),
                ('notes', models.TextField(blank=True,
                                           null=True)),
                ('hours', models.DecimalField(blank=True,
                                              decimal_places=2,
                                              default=1.0,
                                              max_digits=12,
                                              null=True,
