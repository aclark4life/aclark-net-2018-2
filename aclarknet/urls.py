...
urlpatterns = [
    ...
    # Contract Settings
    url(r'^contract-settings/edit$', views.contract_settings_edit, name='contract_settings_edit'),
    url(r'^contract-settings$', views.contract_settings, name='contract_settings'),
    # Estimate
