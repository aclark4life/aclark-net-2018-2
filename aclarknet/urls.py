...
urlpatterns = [
    ...
    # Contract Settings
    url(r'^settings/contract/edit$', views.contract_settings_edit, name='contract_settings_edit'),
    url(r'^settings/contract$', views.contract_settings, name='contract_settings'),
    # Estimate
